...
export const SAMPLE_IMAGES: SampleImage[] = [
  {
    ...
    category: '菜單翻譯', sourceLanguage: 'ja-JP',
    flag: '🇯🇵',
    ...
    presetItems: [
      {
        ...
        category: 'title', sourceLanguage: 'ja-JP',
      },
      {
        id: 'preset-2',
        ...
        category: 'notice', sourceLanguage: 'ja-JP',
      },
      {
        id: 'preset-3',
        ...
        category: 'item', sourceLanguage: 'ja-JP',
      },
      {
        id: 'preset-4',
        ...
        category: 'description', sourceLanguage: 'ja-JP',
      },
      {
        id: 'preset-5',
  ...
  },
  {
    ...
    category: '商品成分與警語', sourceLanguage: 'ja-JP',
    flag: '🇰🇷',
  ...
  },
  {
    ...
    category: '路標與告示', sourceLanguage: 'ja-JP',
    flag: '🇯🇵',
